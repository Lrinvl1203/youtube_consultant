...
const AnalysisSection: React.FC<{ title: string; items: string[] | {title: string; description: string}[]; icon: JSX.Element; }> = ({ title, items, icon }) => (
...
export const ChannelAnalyzer: React.FC = () => {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            ...
            const aiAnalysis = await generateChannelAnalysis(result);
