      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <LanguageSelector />
            <button onClick={onSettingsClick} className="relative p-2 text-slate-300 hover:bg-slate-700 hover:text-white rounded-full transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-1.226.554-.22 1.157-.14 1.707.208l3.223 3.223c.348.349.422.848.208 1.306-.218.455-.666.82-1.226 1.11a48.545 48.545 0 0 1-1.413.533c-1.143.348-2.316.533-3.523.533s-2.379-.185-3.523-.533a48.545 48.545 0 0 1-1.413-.533c-.56-.29-.998-.655-1.226-1.11-.214-.458-.138-.957.208-1.306l3.223-3.223c.55-.348 1.153-.428 1.707-.208.55.218 1.02.684 1.11 1.226Zm-1.606 9.032a48.545 48.545 0 0 1-1.413-.533c-1.143-.348-2.316-.533-3.523-.533s-2.379.185-3.523.533a48.545 48.545 0 0 0-1.413.533c-.56.29-.998.655-1.226 1.11-.214.458-.138-.957.208 1.306l3.223 3.223c.55.348 1.153.428 1.707.208.55-.218 1.02.684 1.11-1.226a48.545 48.545 0 0 0 1.413-.533c1.143-.348 2.316-.533 3.523-.533s2.379.185 3.523.533a48.545 48.545 0 0 0 1.413.533c.56.29.998.655 1.226 1.11.214.458-.138-.957.208-1.306l-3.223-3.223c-.55-.348-1.153-.428-1.707-.208-.55.218-1.02.684-1.11-1.226a48.545 48.545 0 0 1-1.413-.533Z" />
              </svg>
              {!isKeyValid && (
